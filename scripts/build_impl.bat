...
REM This UTF-8 script must only be opened after build.bat switches code page.
if not "%AEGIS_BUILD_WRAPPER%"=="1" (
    echo [ERROR] Run build.bat from the repository root.
    exit /b 1
)
